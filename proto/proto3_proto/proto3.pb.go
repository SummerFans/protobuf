...
type Message struct {
	Name                 string                             `protobuf:"bytes,1,opt,name=name,utf8" json:"name,omitempty"`
	...
	Terrain              map[string]*Nested                 `protobuf:"bytes,10,rep,name=terrain" json:"terrain,omitempty" protobuf_key:"bytes,1,opt,name=key,utf8" protobuf_val:"bytes,2,opt,name=value"`
	Proto2Field          *test_proto.SubDefaults            `protobuf:"bytes,11,opt,name=proto2_field,json=proto2Field" json:"proto2_field,omitempty"`
	Proto2Value          map[string]*test_proto.SubDefaults `protobuf:"bytes,13,rep,name=proto2_value,json=proto2Value" json:"proto2_value,omitempty" protobuf_key:"bytes,1,opt,name=key,utf8" protobuf_val:"bytes,2,opt,name=value"`
	...
	StringMap            map[string]string                  `protobuf:"bytes,20,rep,name=string_map,json=stringMap" json:"string_map,omitempty" protobuf_key:"bytes,1,opt,name=key,utf8" protobuf_val:"bytes,2,opt,name=value,utf8"`
...
type Nested struct {
	Bunny                string   `protobuf:"bytes,1,opt,name=bunny,utf8" json:"bunny,omitempty"`
...
type TestUTF8 struct {
	Scalar string   `protobuf:"bytes,1,opt,name=scalar,utf8" json:"scalar,omitempty"`
	Vector []string `protobuf:"bytes,2,rep,name=vector,utf8" json:"vector,omitempty"`
	// Types that are valid to be assigned to Oneof:
	//	*TestUTF8_Field
	Oneof                isTestUTF8_Oneof `protobuf_oneof:"oneof"`
	MapKey               map[string]int64 `protobuf:"bytes,4,rep,name=map_key,json=mapKey" json:"map_key,omitempty" protobuf_key:"bytes,1,opt,name=key,utf8" protobuf_val:"varint,2,opt,name=value"`
	MapValue             map[int64]string `protobuf:"bytes,5,rep,name=map_value,json=mapValue" json:"map_value,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value,utf8"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
type TestUTF8_Field struct {
	Field string `protobuf:"bytes,3,opt,name=field,utf8,oneof"`
}
